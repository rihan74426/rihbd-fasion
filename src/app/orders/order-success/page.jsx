      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 text-left">
          ...
          <ul className="text-sm text-blue-700 mt-2 space-y-1">
            ...
            <li>• Your product will be delivered to your address</li>
            <li>• Pay cash when you receive the product</li>
          </ul>
        </div>

        {/* WhatsApp Contact (render only if number configured; encode message) */}
        {process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ? (
          <a
            ...
            className="inline-flex items-center justify-center w-full py-3 px-4 bg-green-500 hover:bg-green-600 text-white rounded-md font-medium mb-4 transition-colors"
          >
            <svg
        ...
        <Link
          href="/"
          className="block w-full py-3 px-4 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md font-medium transition-colors"
        >
          Continue Shopping
        </Link>
      </div>
